...
const socialProviders = computed(() => {
    ...
    if (authProviders.value?.google)
        providers.push({ id: "google", name: "Google" });
    if (authProviders.value?.github)
        providers.push({ id: "github", name: "GitHub" });
    if (authProviders.value?.microsoft)
            ...
            <div class="flex flex-col gap-2.5">
                ...
                >
                    <template v-if="socialLoading === provider.id">
                        <svg
                            class="animate-spin size-4 text-surface-400"
                    ...
                    <template v-else>
                        ...
                        <svg
                            ...
                            class="size-5 text-surface-900 dark:text-surface-100"
                            viewBox="0 0 24 24"
                            fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg"
                        >
